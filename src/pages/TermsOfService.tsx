    ...
    <div className="bg-white py-12">
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-8">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          Welcome to AmperSpace! By using our services, you agree to comply
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          AmperSpace shall not be liable for any indirect, incidental, or
        ...
        <p className="text-gray-600 leading-relaxed">
          ...
          contact us at support@ampvc.co.
        </p>
      </div>
    </div>
  );
