...
import team3 from "/src/assets/teamMember3.jpg";
    ...
    <div className="bg-white py-16">
      ...
      <section className="container mx-auto px-4 text-center mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-3 gap-8">
          {[
            { name: "Aniket Tapre", role: "CEO & Founder", image: team1 },
            { name: "Aryan Shrivastava", role: "CTO", image: team2 },
            { name: "Rammuni Diwan", role: "AVP", image: team3 },
          ].map((member, index) => (
            <motion.div
              key={index}
